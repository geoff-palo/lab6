...
#define RADIO_TUNER_ADC_PHASE_OFFSET 0
#define RADIO_TUNER_MIXER_PHASE_OFFSET 4
#define RADIO_TUNER_PHASE_RST_OFFSET 8
#define RADIO_TUNER_CLK_CNTR_OFFSET 12

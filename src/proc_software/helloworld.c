...
int main()
{
    ...
    init_platform();
    print("\r\n\r\n\r\nLab 6 Geoffrey Palo - Custom Peripheral Demonstration\n\r");
    ...
    start_time = RADIO_TUNER_mReadReg(XPAR_RADIO_TUNER_0_S00_AXI_BASEADDR, RADIO_TUNER_CLK_CNTR_OFFSET);
    for (i=0;i<2048;i++)
        stop_time = RADIO_TUNER_mReadReg(XPAR_RADIO_TUNER_0_S00_AXI_BASEADDR, RADIO_TUNER_CLK_CNTR_OFFSET);
    ...
    throughput = 2048*sizeof(u32)*125/(stop_time - start_time);
